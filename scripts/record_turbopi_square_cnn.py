...
parser.add_argument("--heading_gain", type=float, default=2.7, help="Gain for yaw tracking. Halved from the pre-physics-fix 5.4 so the heading loop is overdamped with the corrected plant.")
parser.add_argument("--cross_track_heading_gain", type=float, default=1.2, help="Extra yaw correction that turns the robot toward the lookahead point instead of sliding sideways.")
